    ...
    Private Sub LoadGuests(Optional filter As String = "")
        Try
            Using conn As New SqlConnection(connStr)
                ...
                "FROM tbl_Guests " &
                "WHERE (@filter = '' OR FirstName LIKE @search " &
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        Try
            Using conn As New SqlConnection(connStr)
                ...
                WriteAuditLog("ADD", "Guest", -1,
                "Added guest: " & txtFirstName.Text.Trim() & " " & txtLastName.Text.Trim())
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            Using conn As New SqlConnection(connStr)
                ...
                WriteAuditLog("UPDATE", "Guest", selectedGuestID,
                "Updated guest ID " & selectedGuestID & ": " &
        ...
        If confirm = DialogResult.Yes Then
            Try
                Using conn As New SqlConnection(connStr)
                    ...
                    WriteAuditLog("DELETE", "Guest", selectedGuestID,
                    "Deleted guest ID " & selectedGuestID)
                    ClearFields()
                    LoadGuests()
                End Using
            Catch ex As Exception
