...
Public Class RoomManagement
    ...
    Private Sub LoadRooms(Optional filter As String = "")
        Try
            Using conn As New SqlConnection(connStr)
                ...
                "FROM tbl_Rooms " &
                "WHERE (@filter = '' OR RoomNumber LIKE @search " &
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        Try
            Using conn As New SqlConnection(connStr)
                ...
                WriteAuditLog("ADD", "Room", -1,
                "Added room: " & txtRoomNumber.Text.Trim() &
                " type: " & cmbRoomType.SelectedItem.ToString() &
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            Using conn As New SqlConnection(connStr)
                ...
                WriteAuditLog("UPDATE", "Room", selectedRoomID,
                "Updated room ID " & selectedRoomID & ": " &
                txtRoomNumber.Text.Trim() & " status: " & cmbStatus.SelectedItem.ToString())
                ClearFields()
                LoadRooms()
            End Using
        Catch ex As Exception
        ...
        If confirm = DialogResult.Yes Then
            Try
                Using conn As New SqlConnection(connStr)
                    ...
                    WriteAuditLog("DELETE", "Room", selectedRoomID,
                    "Deleted room ID " & selectedRoomID)
                    ClearFields()
                    LoadRooms()
                End Using
            Catch ex As Exception
    ...
    Private Sub dgvRooms_RowPrePaint(sender As Object, e As DataGridViewRowPrePaintEventArgs) Handles dgvRooms.RowPrePaint
        ...
        Select Case status
            Case "Available"
                dgvRooms.Rows(e.RowIndex).DefaultCellStyle.BackColor = Color.FromArgb(220, 255, 220)  ' Green
            Case "Reserved"
                dgvRooms.Rows(e.RowIndex).DefaultCellStyle.BackColor = Color.FromArgb(210, 230, 255)  ' Blue
            Case "Occupied"
                dgvRooms.Rows(e.RowIndex).DefaultCellStyle.BackColor = Color.FromArgb(255, 220, 220)  ' Red
            Case "Maintenance"
                dgvRooms.Rows(e.RowIndex).DefaultCellStyle.BackColor = Color.FromArgb(255, 245, 200)  ' Yellow
        End Select
    End Sub
